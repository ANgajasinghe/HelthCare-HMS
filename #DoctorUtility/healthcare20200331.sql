...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2020 at 09:30 PM
...
CREATE TABLE `doctors` (
  ...
  `doc_address_no` int(10) NOT NULL,
  `doc_address_lane1` varchar(100) NOT NULL,
  `doc_address_lane2` varchar(100) NOT NULL,
  `doc_address_lane3` int(100) DEFAULT NULL,
  `doc_zipcode` int(8) DEFAULT NULL,
  `doc_tp1` int(15) NOT NULL,
  `doc_tp2` int(15) DEFAULT NULL,
  `doc_tp3` int(15) DEFAULT NULL,
...
(1001, 'admin', 'admin@gmai.com', 'admin', 'admin');
...
ALTER TABLE `login`
  ...
  ADD UNIQUE KEY `log_unique` (`user_id`);
...
--
ALTER TABLE `login`
  MODIFY `login_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1002;
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `delete_log_data` ON SCHEDULE EVERY 2 MINUTE STARTS '2020-03-31 00:05:59' ON COMPLETION NOT PRESERVE ENABLE DO DELETE FROM login where generate_date < TIMESTAMP(timestampadd(minute, -2, now())) ORDER BY generate_date DESC$$
