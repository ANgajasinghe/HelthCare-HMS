...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2020 at 03:40 PM
...
CREATE TABLE IF NOT EXISTS `appointment` (
  ...
  PRIMARY KEY (`app_patient_id`,`app_doc_work_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `doc_specification` (
  `specification_id` int(5) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `doc_work` (
  ...
  PRIMARY KEY (`word_id`),
  UNIQUE KEY `word_id` (`ward_id`,`hospital_id`),
  KEY `doc_id` (`doc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(3, 8080, 'xFjjTA9fjOYym7OiiG4dvhSs8b5GKMQojvdMuy5W0RUEKmATJxA+HyGM+gOaXUQA+i40RhGb/DtLDZKvdkGk/X9RzdoDaOCprv7HAZ/qIjPlJgx1k1Zu7zjFR5+9Nhkd', '2020-04-12 13:21:27', 1, '169.254.143.19', 'DESKTOP-087450S/169.254.143.19');
