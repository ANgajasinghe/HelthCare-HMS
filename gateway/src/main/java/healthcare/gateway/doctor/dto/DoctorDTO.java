package healthcare.gateway.doctor.dto;
...
public class DoctorDTO {
	...
	public String getDoc_zipcode() {
		return doc_zipcode;
	}

	public void setDoc_zipcode(String doc_zipcode) {
		this.doc_zipcode = doc_zipcode;
	}
